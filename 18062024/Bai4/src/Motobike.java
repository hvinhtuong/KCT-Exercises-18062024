public class Motobike extends Vehicle {
    ...
    double distance;
    double speed;
    public Motobike(String name, String color, int year, String fuel, double fuelEffi, double distance, double speed) {
    ...
    public void model() {
        System.out.println("Motorcycle model: " + this.name);
    }
